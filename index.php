...
<link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&family=Rubik+Glitch&display=swap" rel="stylesheet">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Belanosima&family=Mooli&family=Open+Sans&family=Roboto+Condensed:ital@0;1&family=Roboto:wght@100;300;400;900&family=Rubik&display=swap" rel="stylesheet">
...
<div class="w-50 mx-auto d-block ">
    ...
    <div class="creating" id="creating">
        <form action="index.php" method="post">
            <input class="inputtxt" type="text" name="nombre" styles="padding: 2px 4px 2px 4px">
            <button class="btn" type="submit" class="btn-success" name="crear" value="crear" styles="margin-left: 20px;">Crear directorio</button>
        </form>
        <br>
        <br>
    </div>
...
<hr>
    ...
    ?>
                ...
                <div class="col">
                    <div class="card m-4" style="width: 15em; height:10em">
                        <div class="card-body">
